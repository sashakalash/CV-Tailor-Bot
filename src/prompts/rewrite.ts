...
- NEVER modify the contact header fields: name, email, phone, location, github, linkedin must remain EXACTLY as in the original CV. URLs must include the full path (e.g., "https://linkedin.com/in/aleksandr-klshtvn", "https://github.com/sashakalash/aleksandr_klshtvn")
